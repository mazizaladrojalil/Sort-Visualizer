...
function quick_partition (start, end)
{
    ...
    div_update(divs2[start],div_sizes2[start],"blue");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes2[ j ] < piv)
            {
                div_update(divs2[j],div_sizes2[j],"blue");//Color update
                ...
                div_update(divs2[i],div_sizes2[i],"cyan");//Height update
                div_update(divs2[j],div_sizes2[j],"cyan");//Height update
